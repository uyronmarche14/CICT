...
Designs and reviews system-level solutions across `apps/web/` and `apps/backend/`.
...
- Auth is profile-driven on the frontend through [AuthContext.tsx](/home/ronmarche14/projects/CICT/apps/web/src/context/AuthContext.tsx:1).
- Admin visibility is permission-based, not just role-name based, through [use-permissions.ts](/home/ronmarche14/projects/CICT/apps/web/src/hooks/permissions/use-permissions.ts:1).
...
- [apps/web/src/context/AuthContext.tsx](/home/ronmarche14/projects/CICT/apps/web/src/context/AuthContext.tsx:1)
...
- [apps/web/src/lib/updates-hub.ts](/home/ronmarche14/projects/CICT/apps/web/src/lib/updates-hub.ts:1)
