...
const ORG_TOOLS: NavItem[] = [
  ...
  { label: 'Analytics', href: '/analytics', icon: BarChart3, canAccess: (permissions, orgId) => permissions.canManageOrgAnalytics(orgId) },
  { label: 'Partnerships', href: '/partnerships', icon: Handshake, canAccess: (permissions, orgId) => permissions.canManageOrgPartnerships(orgId) },
  { label: 'Collaboration Spaces', href: '/collaborations', icon: MessageSquare, canAccess: (permissions, orgId) => permissions.canManageOrgCollaborations(orgId) },
  { label: 'Shared Content', href: '/shared-content', icon: Share2, canAccess: (permissions, orgId) => permissions.canManageOrgSharedContent(orgId) },
  { label: 'Task Forces', href: '/task-forces', icon: UsersRound, canAccess: (permissions, orgId) => permissions.canManageOrgTaskForces(orgId) },
